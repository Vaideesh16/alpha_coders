    ...
    <div className=" w-full bg-orange-400 p-1 sticky top-0 z-50">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          ...
          <Link to='/'><span className="font-bold">EduTrack</span></Link>
              ...
              <div className="px-5 pb-6 pt-5">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Link
                    to="/signup"
                    type="button"
                    className="mx-3 w-full rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    Sign Up
                  </Link>
                </div>
