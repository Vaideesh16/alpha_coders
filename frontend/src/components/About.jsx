...
const About = () => {
  ...
  return (
    <div className='container flex flex-col items-center justify-center mt-24 px-4 text-center'>
      ...
      <Slider {...settings} className='w-full max-w-3xl mb-24 mt-24 p-5 rounded-3xl shadow-2xl '>
        <div className='p-4'>
          <h2 className='text-2xl font-bold text-black'>Personalized Learning</h2>
          <img src="/about1.png" className='w-96 mx-auto mt-5' alt="" />
        ...
        <div className='p-4'>
          ...
          <img src="/about2.png" className='w-56 mx-auto mt-5' alt="" />
          <p className='text-gray-700'>
        ...
        <div className='p-4'>
          ...
          <img src="about3.jpeg" className='w-80 mx-auto mt-5' alt="" />
          <p className='text-gray-700'>
